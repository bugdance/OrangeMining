    ...
    def setup_actions(self):
        ...
        self.quit_action = \
            QAction(self.tr("Quit"), self,
                    ...
                    toolTip=self.tr("Quit PMT Canvas."),
                    triggered=self.quit,
...
#        self.help_menu.addAction(self.examples_action)
    ...
    def open_scheme(self):
        ...
        filename, _ = QFileDialog.getOpenFileName(
            self, self.tr("Open Workflow File"),
            start_dir, self.tr("Workflow (*.ows)"),
        )
    ...
    def new_scheme_from(self, filename):
        ...
        try:
            ...
            message_critical(
                 self.tr("Could not load an Workflow file"),
                 title=self.tr("Error"),
    ...
    def save_scheme_as(self):
        ...
        filename, _ = QFileDialog.getSaveFileName(
            self, self.tr("Save Workflow File"),
            start_dir, self.tr("Workflow (*.ows)")
        )
    ...
    def welcome_dialog(self):
        ...
        dialog.setWindowTitle(self.tr("欢迎来到PMT!"))
