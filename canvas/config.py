...
def init():
    ...
    QCoreApplication.setOrganizationDomain("cfdsj.cn")
    QCoreApplication.setApplicationName("PMT")
...
def splash_screen():
    ...
    p.drawText(br, Qt.AlignCenter, 'V1')
